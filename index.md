...
venue: "Columbia University (Butler Library, Room 208B"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Butler Library, 535 West 114th Street, Room 208B"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
This is the landing site for Columbia's [Foundations for Research Computing](https://rcfoundations.research.columbia.edu/)  Bootcamp, section {{ page.section }}.
